...
ACCEL_CSV = os.path.join(BASE_DIR, "iwellas_device_usage_2026-03-27_to_2026-06-27.csv")
SURVEY_CSV = os.path.join(BASE_DIR, "iwellas_survey_data_2026-03-27_to_2026-06-27.csv")
output_file = "device_usage_sample_coverage_iwellas.png"
